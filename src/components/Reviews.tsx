...
const Reviews = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      company: 'СК "Монолит"',
      rating: 5,
      text: "Работаем с Спецтех22 уже полгода. Всегда качественные материалы, никаких задержек с доставкой. Особенно нравится, что можно заказать материал даже ночью.",
