          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-accent-foreground/80 text-sm leading-relaxed">
                Поставки качественных строительных материалов с собственным
                автопарком. Работаем с 2023 года, обслужили более 500 клиентов.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">г. Бийск</p>
                    <p className="text-sm text-accent-foreground/80">
                      Алтайский край
                    </p>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-primary/10 rounded-lg p-3">
                  <p className="text-sm font-medium text-primary-foreground">
                    📞 Приём звонков и доставка материалов с 8:00 до 20:00
                  </p>
                </div>
              </div>
            </div>
      ...
      <Dialog open={privacyModalOpen} onOpenChange={setPrivacyModalOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm">
            ...
            <p>
              Мы собираем только ту информацию, которую вы предоставляете
              добровольно: имя, телефон, email, адрес доставки.
            </p>
            <h4 className="font-bold">2. Использование информации</h4>
            <p>
              Персональные данные используются исключительно для обработки
              заказов, связи с клиентами и улучшения качества обслуживания.
            </p>
      ...
      <Dialog open={copyrightModalOpen} onOpenChange={setCopyrightModalOpen}>
        <DialogContent>
          ...
          <div className="space-y-4 text-sm">
            ...
            <p>
              За нарушение авторских прав предусмотрена ответственность в
